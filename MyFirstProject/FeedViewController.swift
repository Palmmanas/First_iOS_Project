...
class FeedViewController: UIViewController{
    ...
    func setupTableViweDummyData(){
        var news:News = News(title: "iOS", description: "Error lets stop doing this", iconImage: #imageLiteral(resourceName: "cheese_flat"), author: "หยุด", view: 2, createDate: "29/06/60",techs:"หมวด")
